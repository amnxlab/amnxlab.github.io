class CustomNavbar extends HTMLElement {
    getBasePath() {
        // Check if we're in a subdirectory within industry (e.g., blog-posts/)
    ...
    getAssetsPath() {
        // Assets are always at the repo root level (../../assets/ from blog-posts, ../assets/ from industry root)
        const path = window.location.pathname;
        const inSubdir = path.includes('/blog-posts/') || path.includes('/pages/');
        return inSubdir ? '../../assets/' : '../assets/';
    }
                ...
                <div class="container mx-auto px-6 py-4">
                    <div class="flex items-center justify-between">
                        <a href="${this.getBasePath()}index.html" class="flex items-center gap-3 text-2xl font-bold font-mono hover:scale-105 transition-transform">
                            <img src="${this.getAssetsPath()}logo.png" alt="AMNx Lab Logo" class="w-10 h-10">
                        ...
                        <div class="hidden md:flex items-center gap-8">
                            ...
                            <a href="../research/index.html" class="text-primary-500 font-semibold hover:text-white transition-colors border border-primary-500/30 px-3 py-1 rounded-md bg-primary-500/10">Research Profile &rarr;</a>
                        </div>
                    ...
                    <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4">
                        <div class="flex flex-col gap-4">
                            ...
                            <a href="${this.getBasePath()}projects.html" class="text-gray-300 hover:text-primary-500 transition-colors">Projects</a>
                            <a href="${this.getBasePath()}blog.html" class="text-gray-300 hover:text-primary-500 transition-colors">Blog</a>
                            <a href="../research/index.html" class="text-primary-500 font-semibold hover:text-white transition-colors">Research Profile &rarr;</a>
                        </div>
                    </div>
                </div>
            </nav>
